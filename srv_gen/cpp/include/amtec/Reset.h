 ...
 * /home/administrator/ros/amtec/srv/Reset.srv */
...
namespace amtec {
template <class ContainerAllocator> struct ResetRequest_ {
  ...
  typedef boost::shared_ptr<amtec::ResetRequest_<ContainerAllocator> const>
      ConstPtr;
...
template <class ContainerAllocator> struct ResetResponse_ {
  ...
  typedef boost::shared_ptr<amtec::ResetResponse_<ContainerAllocator> const>
      ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
...
struct IsMessage<amtec::ResetRequest_<ContainerAllocator> > : public TrueType {
};
template <class ContainerAllocator>
struct IsMessage<amtec::ResetRequest_<ContainerAllocator> const>
    : public TrueType {};
template <class ContainerAllocator>
struct MD5Sum<amtec::ResetRequest_<ContainerAllocator> > {
  static const char *value() { return "d41d8cd98f00b204e9800998ecf8427e"; }

  static const char *value(const ::amtec::ResetRequest_<ContainerAllocator> &) {
    return value();
  }
...
struct DataType<amtec::ResetRequest_<ContainerAllocator> > {
  static const char *value() { return "amtec/ResetRequest"; }
...
template <class ContainerAllocator>
struct IsFixedSize<amtec::ResetRequest_<ContainerAllocator> >
    : public TrueType {};
} // namespace message_traits
} // namespace ros
...
namespace message_traits {
template <class ContainerAllocator>
struct IsMessage<amtec::ResetResponse_<ContainerAllocator> >
    : public TrueType {};
template <class ContainerAllocator>
struct IsMessage<amtec::ResetResponse_<ContainerAllocator> const>
    : public TrueType {};
template <class ContainerAllocator>
struct MD5Sum<amtec::ResetResponse_<ContainerAllocator> > {
  ...
  static const char *
  value(const ::amtec::ResetResponse_<ContainerAllocator> &) {
    return value();
  }
  static const uint64_t static_value1 = 0xd41d8cd98f00b204ULL;
  static const uint64_t static_value2 = 0xe9800998ecf8427eULL;
...
struct DataType<amtec::ResetResponse_<ContainerAllocator> > {
  static const char *value() { return "amtec/ResetResponse"; }
...
template <class ContainerAllocator>
struct IsFixedSize<amtec::ResetResponse_<ContainerAllocator> >
    : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template <class ContainerAllocator>
struct Serializer<amtec::ResetRequest_<ContainerAllocator> > {
...
template <class ContainerAllocator>
struct Serializer<amtec::ResetResponse_<ContainerAllocator> > {
  template <typename Stream, typename T>
  inline static void allInOne(Stream &stream, T m) {}
...
template <> struct MD5Sum<amtec::Reset> {
  static const char *value() { return "d41d8cd98f00b204e9800998ecf8427e"; }

  static const char *value(const amtec::Reset &) { return value(); }
};

template <> struct DataType<amtec::Reset> {
  static const char *value() { return "amtec/Reset"; }
...
struct MD5Sum<amtec::ResetResponse_<ContainerAllocator> > {
  ...
  static const char *value(const amtec::ResetResponse_<ContainerAllocator> &) {
    return value();
  }
};
